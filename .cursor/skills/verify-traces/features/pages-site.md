...
- **Sections.** `#features` cards include GRAPH, EDITOR, TRACESAI, and LOCAL-FIRST. GRAPH copy names Galaxy, Terrain, Cluster, and Particle. `#run` heading is `Clone it. Run it.` The clone blurb asks for Node 22 and pnpm 10.
...
- The page and `docs/webmcp.js` `get-install-instructions` both say Node 22 and pnpm 10. If they disagree again, report the mismatch. Do not change this map to match a stale tool answer.
